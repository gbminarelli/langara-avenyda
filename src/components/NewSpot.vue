<template>
  <b-container fluid>
    <b-row class="mb-4">
      <b-col class="gray-bg add-spot spot-img-size text-center m-2" cols="auto" @click="fillForm()">
        <font-awesome-icon :icon="['fas', 'plus']" class="fa-4x" />
      </b-col>
      <b-col class="add-spot text-center pt-0 px-0 m-2" cols="auto">
        <!-- <b-img rounded="0" class="spot-img-size" fluid src="../assets/house2.jpg" alt="house" /> -->
        <b-img rounded="0" class="spot-img-size" fluid src="../assets/house2.jpg" alt="house" @click="fillForm(true)" />
      </b-col>
    </b-row>
    <b-row class="p-5 text-left gray-bg" id="new-spot" fluid>
      ...
      <b-form>
        ...
        <b-row class="my-5" align-h="center">
          ...
          <b-col class="image-preview my-4" cols="auto" v-if="placeholderData">
            <b-img v-bind="imageProps" rounded="circle" class="preview" src="../assets/house2.jpg"/>
          </b-col>
        </b-row>
        <b-row class="my-5" align-h="center">
          <b-container fluid class="mb-4">
        ...
        <b-row align-h="end">
          <b-button type="submit" variant="primary" size="lg" v-if="placeholderData">Update</b-button>
          <b-button type="submit" variant="primary" size="lg" v-else>Post</b-button>
        </b-row>
      </b-form>
    </b-row>
  </b-container>
...
<script>
  export default {
    ...
    methods: {
      ...
      fillForm: function (placeholder) {
        // this.$router.go();
        if (placeholder) {
          this.title = "Eduardo's parking spot",
          this.street = "700-796 E 12th Ave",
          this.buildingName = " ",
          this.city = "Vancouver",
          this.state = "BC",
          this.zip = "V5T 2H9",
          this.country = "Canada",
          this.spotTypeButtons[2].state = true,
          this.features[0].state = true,
          this.features[1].state = true,
          this.carTypeButtons[1].state = true,
          this.description = "Well lit and covered parking spot. Fast and easy check-in & check-out.",
          this.instructions = " ",
          this.availabilityWeek24[2] = true,
          this.availabilityWeek24[5] = true,
          this.prices[0] = true,
          this.priceHour = "17",
          ...
          this.zip = "",
          this.country = "",
          this.spotTypeButtons[2].state = false,
          this.features[0].state = false,
          this.features[1].state = false,
          this.carTypeButtons[1].state = false,
          this.description = "",
          this.instructions = "",
          this.availabilityWeek24[2] = false,
          this.availabilityWeek24[5] = false,
          this.prices[0] = false,
          this.priceHour = "",
